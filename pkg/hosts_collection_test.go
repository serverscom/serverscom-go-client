...
func TestHostsEmptyCollection(t *testing.T) {
	...
	collection := NewHostsCollection(client)
...
func TestHostsCollectionList(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionHasNext(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionHasPrevious(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionHasFirst(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionHasLast(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionHasRelations(t *testing.T) {
	g := NewGomegaWithT(t)
	...
	ts, client := newFakeServer().
		...
		WithRequestMethod("GET").
		WithResponseHeaders(map[string]string{
			"Link": `<https://dummy.api.com/hosts?page=3&per_page=2>; rel="next",<https://dummy.api.com/hosts?page=1&per_page=2>; rel="prev",<https://dummy.api.com/hosts?page=1&per_page=2>; rel="first",<https://dummy.api.com/hosts?page=3&per_page=2>; rel="last"`,
		}).
		WithResponseBodyStubInline(`[{"id": "a"}, {"id": "b"}]`).
		WithResponseCode(200).
		Build()
...
func TestHostsCollectionNext(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionPrevious(t *testing.T) {
	g := NewGomegaWithT(t)
	...
	collection := NewHostsCollection(client).SetPage(2).SetPerPage(2)
...
func TestHostsCollectionFirst(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionLast(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestHostsCollectionCollect(t *testing.T) {
	g := NewGomegaWithT(t)
