...
// CloudInstancePTRRecordsCollection is an interface for interfacing with the collection of PTRRecord
// Endpoint: https://developers.servers.com/api-documentation/v1/#operation/ReturnsInstancePtrRecords
type CloudInstancePTRRecordsCollection interface {
	IsClean() bool
	...
	SetPage(page int) CloudInstancePTRRecordsCollection
	SetPerPage(perPage int) CloudInstancePTRRecordsCollection

	Refresh(ctx context.Context) error
}

// CloudInstancePTRRecordsCollectionHandler handles opertations aroud collection
...
func (col *CloudInstancePTRRecordsCollectionHandler) IsClean() bool {
	return col.clean
}
...
func (col *CloudInstancePTRRecordsCollectionHandler) HasPreviousPage() bool {
...
//
// First metadata will come with the first called methods such: NextPage, PreviousPage, LastPage, FirstPage, List, Refresh, Collect.
func (col *CloudInstancePTRRecordsCollectionHandler) HasNextPage() bool {
...
//
// First metadata will come with the first called methods such: NextPage, PreviousPage, LastPage, FirstPage, List, Refresh, Collect.
func (col *CloudInstancePTRRecordsCollectionHandler) HasFirstPage() bool {
...
//
// First metadata will come with the first called methods such: NextPage, PreviousPage, LastPage, FirstPage, List, Refresh, Collect.
func (col *CloudInstancePTRRecordsCollectionHandler) HasLastPage() bool {
...
func (col *CloudInstancePTRRecordsCollectionHandler) NextPage(ctx context.Context) ([]PTRRecord, error) {
...
// You can force to load pagination metadata by calling Refresh or List methods.
func (col *CloudInstancePTRRecordsCollectionHandler) PreviousPage(ctx context.Context) ([]PTRRecord, error) {
...
// You can force to load pagination metadata by calling Refresh or List methods.
func (col *CloudInstancePTRRecordsCollectionHandler) FirstPage(ctx context.Context) ([]PTRRecord, error) {
...
// You can force to load pagination metadata by calling Refresh or List methods.
func (col *CloudInstancePTRRecordsCollectionHandler) LastPage(ctx context.Context) ([]PTRRecord, error) {
...
func (col *CloudInstancePTRRecordsCollectionHandler) Collect(ctx context.Context) ([]PTRRecord, error) {
...
func (col *CloudInstancePTRRecordsCollectionHandler) List(ctx context.Context) ([]PTRRecord, error) {
	if col.IsClean() {
...
func (col *CloudInstancePTRRecordsCollectionHandler) SetPage(page int) CloudInstancePTRRecordsCollection {
...
func (col *CloudInstancePTRRecordsCollectionHandler) SetPerPage(perPage int) CloudInstancePTRRecordsCollection {
...
func (col *CloudInstancePTRRecordsCollectionHandler) Refresh(ctx context.Context) error {
...
func (col *CloudInstancePTRRecordsCollectionHandler) navigate(ctx context.Context, name string) ([]PTRRecord, error) {
	if col.IsClean() {
		if err := col.Refresh(ctx); err != nil {
			return nil, err
		}
...
func (col *CloudInstancePTRRecordsCollectionHandler) applyParam(name, value string) {
	if value == "" {
...
func (col *CloudInstancePTRRecordsCollectionHandler) applyRel(name string) error {
	if !col.hasRel(name) {
...
func (col *CloudInstancePTRRecordsCollectionHandler) hasRel(name string) bool {
