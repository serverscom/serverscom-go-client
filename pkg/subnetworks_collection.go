...
// SubnetworksCollection is an interface for interfacing with the collection of Subnetwork
// Endpoint: https://developers.servers.com/api-documentation/v1/#operation/ListAllSubnetworks
type SubnetworksCollection interface {
	IsClean() bool
	...
	NextPage(ctx context.Context) ([]Subnetwork, error)
	PreviousPage(ctx context.Context) ([]Subnetwork, error)
	FirstPage(ctx context.Context) ([]Subnetwork, error)
	LastPage(ctx context.Context) ([]Subnetwork, error)

	Collect(ctx context.Context) ([]Subnetwork, error)
	List(ctx context.Context) ([]Subnetwork, error)
...
type SubnetworksCollectionHandler struct {
	client *Client
...
func NewSubnetworksCollection(client *Client, networkPoolID string) SubnetworksCollection {
	return &SubnetworksCollectionHandler{
		client: client,
...
func (col *SubnetworksCollectionHandler) HasPreviousPage() bool {
...
//
// First metadata will come with the first called methods such: NextPage, PreviousPage, LastPage, FirstPage, List, Refresh, Collect.
func (col *SubnetworksCollectionHandler) HasNextPage() bool {
...
//
// First metadata will come with the first called methods such: NextPage, PreviousPage, LastPage, FirstPage, List, Refresh, Collect.
func (col *SubnetworksCollectionHandler) HasFirstPage() bool {
...
//
// First metadata will come with the first called methods such: NextPage, PreviousPage, LastPage, FirstPage, List, Refresh, Collect.
func (col *SubnetworksCollectionHandler) HasLastPage() bool {
	return col.hasRel("last")
}

// NextPage navigates to the next page returns a []Subnetwork, produces an error, when a
...
func (col *SubnetworksCollectionHandler) NextPage(ctx context.Context) ([]Subnetwork, error) {
	return col.navigate(ctx, "next")
}

// PreviousPage navigates to the previous page returns a []Subnetwork, produces an error, when a
...
// You can force to load pagination metadata by calling Refresh or List methods.
func (col *SubnetworksCollectionHandler) PreviousPage(ctx context.Context) ([]Subnetwork, error) {
	return col.navigate(ctx, "prev")
}

// FirstPage navigates to the first page returns a []Subnetwork, produces an error, when a
// collection has no first page.
//
// Before using this method please ensure IsClean returns false and HasFirstPage returns true.
// You can force to load pagination metadata by calling Refresh or List methods.
func (col *SubnetworksCollectionHandler) FirstPage(ctx context.Context) ([]Subnetwork, error) {
	return col.navigate(ctx, "first")
}

// LastPage navigates to the last page returns a []Subnetwork, produces an error, when a
// collection has no last page.
//
// Before using this method please ensure IsClean returns false and HasLastPage returns true.
// You can force to load pagination metadata by calling Refresh or List methods.
func (col *SubnetworksCollectionHandler) LastPage(ctx context.Context) ([]Subnetwork, error) {
...
func (col *SubnetworksCollectionHandler) Collect(ctx context.Context) ([]Subnetwork, error) {
	var accumulatedCollectionElements []Subnetwork
...
func (col *SubnetworksCollectionHandler) List(ctx context.Context) ([]Subnetwork, error) {
	if col.IsClean() {
...
func (col *SubnetworksCollectionHandler) SetPage(page int) SubnetworksCollection {
...
func (col *SubnetworksCollectionHandler) SetPerPage(perPage int) SubnetworksCollection {
...
func (col *SubnetworksCollectionHandler) Refresh(ctx context.Context) error {
...
func (col *SubnetworksCollectionHandler) fireHTTPRequest(ctx context.Context) error {
	var accumulatedCollectionElements []Subnetwork

	initialURL := col.client.buildURL(subnetworkListPath, col.networkPoolID)
...
func (col *SubnetworksCollectionHandler) navigate(ctx context.Context, name string) ([]Subnetwork, error) {
	if col.IsClean() {
		if err := col.Refresh(ctx); err != nil {
			return nil, err
		}
...
func (col *SubnetworksCollectionHandler) applyParam(name, value string) {
	if value == "" {
...
func (col *SubnetworksCollectionHandler) applyRel(name string) error {
	if !col.hasRel(name) {
...
func (col *SubnetworksCollectionHandler) hasRel(name string) bool {
